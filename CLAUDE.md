...
- **El correo del autorizador (`ajustes.correo_autorizador`) es sólo lectura en el panel.** Es la llave del alta de cuentas; se cambia desde la base, no desde el clasificador.
